...
class AclUtilService {
	...
	void addPermission(domainObject, recipient, Permission permission) {
		println "AP2: DOMAIN OBJECT: "+domainObject
	...
	void addPermission(ObjectIdentity oid, recipient, Permission permission) {
		println "AP3 DOMAIN OBJECT: "+oid+","+recipient+","+permission
		...
		try {
			...
			println "FINISHED WITH THE ACL SERVICE"
		}
		catch (NotFoundException e) {
			acl = aclService.createAcl(oid)
		}

		println "DOING MORE ACL STUFF NOW"
